...
const MC_GROUPS = [
  {
    ...
    questions: [
      {
        id: "mc1",
        question: "Bug SEVERITY refers to:",
        options: [
          "How quickly the bug needs to be fixed by the development team",
          "How many different players or testers have reported the same bug",
          "How much the bug impacts the game's functionality or player experience",
          "Which platform or device the bug was originally discovered on"
        ],
        correct: 2
      },
      {
        id: "mc2",
        question: "Bug PRIORITY refers to:",
        options: [
          "How technically serious the bug is in terms of game functionality",
          "The order in which bugs should be addressed and fixed",
          "Whether the bug affects the game's graphics or its gameplay systems",
          "How long it takes a tester to reliably reproduce the bug"
        ],
        correct: 1
      },
      {
        id: "mc3",
        question: "Which of the following is NOT typically included in a bug report?",
        options: [
          "Step-by-step instructions showing exactly how to reproduce the bug",
          "A description of what was expected to happen versus what actually happened",
          "The tester's personal opinion on the quality of the game's storyline",
          "Screenshots or video footage showing the bug occurring in the game"
        ],
        correct: 2
      },
    ]
    ...
    questions: [
      {
        ...
        options: [
          "A document that records every bug found during testing, including reproduction steps and severity ratings",
          "A set of instructions describing how to test a specific feature and what the expected outcome should be",
          "A checklist completed by testers at the end of each session to confirm all assigned tasks were finished",
          "A report submitted to developers summarising the outcomes and recommendations from a testing period"
        ],
        correct: 1
      },
      {
        id: "mc5",
        question: "What is the main difference between a test case and a bug report?",
        options: [
          "A test case is written after testing is done; a bug report is prepared before the session starts",
          "A test case describes what to test and what to expect; a bug report documents something that went wrong",
          "A bug report covers only game crashes and freezes; a test case is used for everything else",
          "A test case is only used in large studios; a bug report is used by freelance testers"
        ],
        correct: 1
      },
      {
        id: "mc6",
        question: "A tester follows a test case and the game behaves exactly as expected. What is the correct outcome to record?",
        options: [
          "Fail — because something unexpected happened during the test",
          "Blocked — because the test could not be fully completed",
          "Pass — because the game matched the expected result",
          "In Progress — because additional testing is still required"
        ],
        correct: 2
      },
    ]
    ...
    questions: [
      {
        ...
        options: [
          "A document that records every bug found during testing, including reproduction steps and severity ratings",
          "A high-level document outlining what will be tested, how it will be tested, and what resources and schedule are required",
          "A checklist completed by testers at the end of each session to confirm all assigned tasks were finished",
          "A report submitted to developers summarising the outcomes and recommendations from a testing period"
        ],
        correct: 1
      ...
      {
        id: "mc8",
        question: "How does a test plan differ from a test case?",
        options: [
          "A test plan covers the overall strategy and scope of testing; a test case describes specific steps to test one feature",
          "A test plan is written by developers after release; a test case is written by testers before the session begins",
          "A test plan is only used for bug testing sessions; a test case is only used during playtest sessions",
          "A test plan lists every bug found in the game; a test case describes how to prevent those bugs from occurring"
        ],
        correct: 0
      },
      {
        id: "mc9",
        question: "Which of the following would you expect to find in a test plan but NOT in a test case?",
        options: [
          "The specific steps required to test whether a menu button works correctly",
          "The expected result when a player attempts to save their progress in the game",
          "The overall scope, schedule, and objectives for the entire testing effort",
          "The actual versus expected result recorded after a single test is executed"
        ],
        correct: 2
      },
      {
        id: "mc10",
        question: "A studio needs a document describing the goals of testing, what parts of the game will be covered, and the timeline. What do they need?",
        options: [
          "A bug report, so that issues found can be tracked and assigned to developers straight away",
          "A test case, so that testers know the exact steps to follow when playing through the game",
          "A test plan, so that everyone understands the scope, objectives, and approach for the testing",
          "A feedback form, so that playtesters can record their experience and rate the game after playing"
        ],
        correct: 2
      },
    ]
  },
  {
    ...
    questions: [
      {
        id: "mc11",
        question: "Which of these is a freelance job platform where game testers can find work?",
        options: [
          "Steam",
          "Upwork",
          "Itch.io",
      ...
      {
        id: "mc12",
        question: "Which of the following must always be included on a professional invoice?",
        options: [
          "Your ABN, services provided, amount due, and payment terms",
          "Your ABN, a description of services, and your bank account details only",
          "Client name, services provided, and your signature",
          "Invoice number, services provided, and your LinkedIn profile"
        ],
        correct: 0
      },
      {
        ...
        options: [
          ...
          "Authorised Business Name",
          "Australian Banking Node"
        ],
        correct: 1
      },
      {
        id: "mc14",
        question: "In Australia, once a freelancer earns more than this amount in a year, they generally need to register for GST:",
        options: [
          "$25,000",
          "$50,000",
          "$75,000",
      ...
      {
        id: "mc15",
        question: "A common rule of thumb for freelancers is to set aside approximately this percentage of income for tax:",
        options: [
          "5–10%",
          "10–15%",
          "25–30%",
  ...
  },
  {
    ...
    questions: [
      {
        id: "mc16",
        question: "As a freelance game tester, you would be classified as:",
        options: [
          "A permanent employee of the studio you test for",
          "A casual employee entitled to leave and superannuation",
          "An independent contractor responsible for your own tax",
          "A volunteer contributing to the game development process"
        ],
        correct: 2
      },
      {
        id: "mc17",
        question: "Usability testing focuses on:",
        options: [
          "Finding crashes, freezes, and technical error codes in the game",
          "Testing the game across multiple platforms and hardware configurations",
          "Evaluating how easy and intuitive the game is for players to use",
          "Measuring the game's frame rate and memory usage under load"
        ],
        correct: 2
      },
    ]
...
const Field = ({ label, hint, value, onChange, rows = 3 }) => (
  <div style={{ marginBottom: "20px" }}>
    ...
    <textarea value={value} onChange={e => onChange(e.target.value)} rows={rows} style={{ width: "100%", border: "1.5px solid #ccc", borderRadius: "3px", padding: "10px 12px", fontFamily: "'Georgia', serif", fontSize: "14px", color: "#1a1a2e", resize: "vertical", outline: "none", boxSizing: "border-box", lineHeight: "1.6", background: "#fafaf8" }}
...
export default function FreelanceReflection() {
  ...
  const mcScore = mcSubmitted ? ALL_QUESTIONS.filter(q => mcAnswers[q.id] === q.correct).length : null;
    ...
    <div style={{ minHeight: "100vh", background: "#f5f0e8", fontFamily: "'Georgia', serif" }}>
      ...
      <div className="no-print" style={{ background: "#fff", borderBottom: "1px solid #ddd", padding: "10px 32px" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto", display: "flex", alignItems: "center", gap: "14px" }}>
          <div style={{ fontFamily: "'Courier Prime', monospace", fontSize: "12px", color: "#666", whiteSpace: "nowrap", minWidth: "120px", overflow: "hidden", textOverflow: "ellipsis" }}>
            {name.trim() ? name : "No name yet"}
          </div>
          ...
          <div style={{ fontFamily: "'Courier Prime', monospace", fontSize: "12px", fontWeight: "700", color: pct === 100 ? "#2d7a2d" : "#1a1a2e", whiteSpace: "nowrap" }}>
            {pct === 100 ? "✓ DONE" : `${pct}%`}
          </div>
          ...
          {TABS.map(tab => {
            ...
            return (
              <button key={tab.id} onClick={() => setActiveTab(tab.id)} style={{ background: "none", border: "none", borderBottom: active ? "3px solid #e8c547" : "3px solid transparent", padding: "12px 16px", fontFamily: "'Courier Prime', monospace", fontSize: "11px", fontWeight: "700", color: active ? "#1a1a2e" : done ? "#2d7a2d" : "#999", cursor: "pointer", whiteSpace: "nowrap", letterSpacing: "0.04em", display: "flex", alignItems: "center", gap: "6px" }}>
                {done && <span style={{ color: "#2d7a2d" }}>✓</span>}
                {tab.label}
              </button>
            );
          })}
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "32px 24px" }}>
        ...
        {activeTab === "testing" && (
          <div>
            ...
            <Field label="How I would find and report a bug" hint="Walk through the steps — from finding something wrong in a game to submitting the report. What information would you include? (A quick Google of 'what to include in a bug report' will help if needed.)" value={bugProcess} onChange={setBugProcess} rows={5} />
        ...
        {activeTab === "freelancing" && (
          <div>
            ...
            <Field label="How I would describe my services to a potential client" hint="Imagine someone asks 'what do you do?' — write a short, clear description of what you could offer as a freelance game tester." value={pitch} onChange={setPitch} rows={3} />
            <Field label="What I would include on an invoice for game testing work" hint="List the key things that should appear on a professional invoice. (A quick Google of 'what to include on a freelance invoice Australia' will help if needed.)" value={invoice} onChange={setInvoice} rows={3} />
          </div>
        )}
        ...
        {activeTab === "tax" && (
          <div>
            ...
            <Field label="What is an ABN and why does a freelancer need one?" hint="ABN stands for Australian Business Number. Look it up if you need to — what is it, and why would you need one as a freelance game tester?" value={abn} onChange={setAbn} rows={3} />
            <Field label="How would you manage tax as a freelancer?" hint="You won't have an employer taking tax out automatically. What should you do? Think about: setting money aside, GST registration, and keeping records of your income and expenses." value={taxApproach} onChange={setTaxApproach} rows={4} />
          </div>
        )}
        ...
        {activeTab === "knowledge" && (
          <div>
            <div style={{ marginBottom: "24px" }}>
              ...
              <div style={{ color: "#666", fontSize: "13px", fontFamily: "'Georgia', serif", fontStyle: "italic" }}>Open each section and answer all questions. Choose carefully — answers lock on submit.</div>
            </div>
            <div style={{ background: "rgba(232,197,71,0.12)", border: "1.5px solid #e8c547", borderRadius: "4px", padding: "12px 16px", marginBottom: "20px", fontFamily: "'Courier Prime', monospace", fontSize: "12px", color: "#1a1a2e" }}>
              ⚠ Answer all {totalMC} questions across all sections before submitting. You cannot change your answers after submitting. · {answeredMC}/{totalMC} answered
            </div>
            {MC_GROUPS.map(group => (
            ...
            {mcSubmitted && (
              <div style={{ background: mcScore >= 12 ? "rgba(45,122,45,0.08)" : "rgba(180,40,40,0.08)", border: `2px solid ${mcScore >= 12 ? "#2d7a2d" : "#b42828"}`, borderRadius: "4px", padding: "16px 20px", fontFamily: "'Courier Prime', monospace", fontSize: "14px", color: "#1a1a2e", marginTop: "16px" }}>
                <strong>You scored {mcScore}/{totalMC}</strong>
                {mcScore >= 12 ? " — Well done. Move on to the Reflection tab to finish." : " — Review the highlighted answers above, then move on to the Reflection tab."}
              </div>
            )}
          </div>
        )}
        ...
        {activeTab === "submit" && (
          <div>
            ...
            <button onClick={() => declared && window.print()} disabled={!declared} style={{ background: declared ? "#e8c547" : "#ccc", border: "none", borderRadius: "3px", color: declared ? "#1a1a2e" : "#999", padding: "14px 32px", fontFamily: "'Courier Prime', monospace", fontSize: "14px", fontWeight: "700", cursor: declared ? "pointer" : "not-allowed", letterSpacing: "0.05em" }}>
              {declared ? "Print / Save as PDF" : "Complete declaration to submit"}
            </button>
          </div>
        )}
